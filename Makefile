#############################################################################
# Makefile for building: hdhomerun-gui
# Generated by qmake (3.1) (Qt 5.14.2)
# Project:  hdhomerun-gui.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile hdhomerun-gui.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = hdhomerun-gui1.0.0
DISTDIR = /home/scoronado/Code/hdhomerun/hdhomerun-gui/.tmp/hdhomerun-gui1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lcurl /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		hdhomerun-gui.pro channel.h \
		mainwindow.h channel.cpp \
		main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = hdhomerun-gui
DESTDIR       = 
TARGET        = hdhomerun-gui


first: all
####### Build rules

hdhomerun-gui: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: hdhomerun-gui.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		hdhomerun-gui.pro
	$(QMAKE) -o Makefile hdhomerun-gui.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents channel.h mainwindow.h $(DISTDIR)/
	$(COPY_FILE) --parents channel.cpp main.cpp mainwindow.cpp $(DISTDIR)/
	$(COPY_FILE) --parents mainwindow.ui $(DISTDIR)/
	$(COPY_FILE) --parents hdhomerun-gui_en_US.ts $(DISTDIR)/
...
moc_mainwindow.cpp: mainwindow.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/scoronado/Code/hdhomerun/hdhomerun-gui/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/scoronado/Code/hdhomerun/hdhomerun-gui -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/9.3.0 -I/usr/include/c++/9.3.0/x86_64-pc-linux-gnu -I/usr/include/c++/9.3.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.3.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.3.0/include-fixed -I/usr/include mainwindow.h -o moc_mainwindow.cpp
...
mainwindow.o: mainwindow.cpp channel.h \
		mainwindow.h \
		ui_mainwindow.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/hdhomerun-gui/bin || mkdir -p $(INSTALL_ROOT)/opt/hdhomerun-gui/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/hdhomerun-gui/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/hdhomerun-gui/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/hdhomerun-gui/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/hdhomerun-gui/bin/ 
